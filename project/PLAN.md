...
- [x] Priority steering: compact sidebar buttons, icons and spacing while keeping
  readable labels and independent scrolling; verify normal and narrow widths in
  the running browser, then commit and push.
