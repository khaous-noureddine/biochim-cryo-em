...
| CORE-034 | Hélices, brins beta, coils et lignes | `_LingFactory`, définitions `objectdata` | partiel | hélice, brin beta, coil, trait plein/pointillé, connecteurs haut/bas et soulignement créables, éditables, persistés et testés ; variantes `Helix2` et `Strand2` à reproduire |
