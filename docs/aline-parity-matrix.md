...
| CORE-035 | Boîtes, rectangles et textes | `Box`, `Rect`, `DrawText` | partiel | boîtes/rectangles 2D créables depuis une sélection, rendus, éditables, remappés et persistés ; textes à ajouter |
