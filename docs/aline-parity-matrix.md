...
| CORE-037 | Menus, raccourcis et actions configurables | `_BuildMenu`, bindings, `setaction` | partiel | UI command inventory; 2026-09-16 browser verification: header menu layering in both views, exclusive opening, outside-click/action/Escape dismissal and modal backdrop dismissal |
