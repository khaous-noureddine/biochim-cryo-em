...
| CORE-002 | Open/save/save as `.aline` | `Open`, `DumpDataFile`, `UndumpDataFile`, `savepackaline`, `loadpackaline` | partial | `aline-packed-format.md` and `npm run test:aline-oracle`: 35 historical assertions; rich Atlas import fixtures and lossless `.atlas` round trips remain required |
